...
const DASHBOARD_OPTIONS: {
  ...
  { type: "conflict_topology_map", label: "Conflict Map", description: "Network graph of conflicts", implemented: false },
  { type: "decision_waterfall", label: "Decision Waterfall", description: "Sequential decision flow", implemented: false },
  { type: "resolution_radar", label: "Resolution Radar", description: "Polar chart of resolution progress", implemented: false },
  { type: "role_coverage_map", label: "Role Coverage", description: "Heatmap of role participation", implemented: false },
  ...
  { type: "contribution_timeline", label: "Timeline", description: "Chronological contribution view", implemented: false },
