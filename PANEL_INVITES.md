...
## Previously Contacted (moved from Next Targets)
...
|------|-------|-------------|-------|
| Cynthia Rudin | cynthia@cs.duke.edu (verify on Duke directory) | Duke CS/ECE — interpretable ML | Great AI researcher but focused on ML transparency, not workforce/jobs |
| Jessilyn Dunn | jessilyn.dunn@duke.edu | Duke BME — digital health | AI for clinical tools, not workforce displacement |
| Amanda Randles | amanda.randles@duke.edu | Duke BME/CS — simulation | Computational biology, no workforce angle |
| Guillermo Sapiro | guillermo.sapiro@duke.edu | Duke ECE (Emeritus) / Apple Health AI | Now at Apple, likely unavailable |
