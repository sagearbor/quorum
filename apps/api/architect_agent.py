...
_ROLE_GENERATION_INSTRUCTIONS = (
    ...
    "how this turn moved that metric. Use NEGATIVE numbers when this turn "
    "surfaced regressions — new conflicts, blockers, scope creep, missing "
    "evidence. Use POSITIVE numbers when this turn resolved a blocker, "
    "found agreement, or filled a critical gap. Use 0 or omit keys that "
    "did not move. Optionally follow with [scores-why: ...] (< 100 chars) "
    "explaining the largest movement. Examples:\n"
    "      [scores: consensus=-12, blockers=+6]\n"
    "      [scores-why: IRB raised consent issue — new blocker, eroded agreement]\n"
    "    or:\n"
    "      [scores: completion=+8, role_coverage=+4, consensus=+5]\n"
    "      [scores-why: methodology now agreed; ethicist & researcher aligned]\n"
    "    Stay honest — if nothing moved, omit the block entirely.\n\n"
